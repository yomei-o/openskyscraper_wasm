...
namespace OSS {
	...
	public:
		...
		// One pass of the run loop.  run() blocks in a while loop on desktop,
		// but a browser owns the frame clock, so the Emscripten build drives
		// this from emscripten_set_main_loop instead.
